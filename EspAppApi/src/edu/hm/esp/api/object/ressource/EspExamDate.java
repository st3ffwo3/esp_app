...
/**
 * Klasse repraesentiert die Ressource Pruefungsdatum.
 * 
 * @author Stefan Wörner
 */
@XmlRootElement( name = "ExamineDate" )
...
public class EspExamDate extends AbstractEspRessourceObject
{

	private static final long serialVersionUID = -2482033470768057351L;
	...
	public boolean equals( Object obj )
	{
		...
		if (!(obj instanceof EspExamDate))
		{
			return false;
		}

		EspExamDate examDate = (EspExamDate) obj;

		EqualsBuilder eb = new EqualsBuilder();
		eb.append( getStartDate(), examDate.getStartDate() );
		eb.append( getEndDate(), examDate.getEndDate() );
