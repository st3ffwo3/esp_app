...
public class EspExamList extends AbstractEspRessourceObject
{

	private static final long serialVersionUID = -6874316491505291552L;
	...
	/**
	 * Fuegt der Liste der Pruefungen eine neue Pruefung hinzu (falls diese noch nicht enthalten ist).
	 * 
	 * @param exam
	...
	public boolean equals( Object obj )
	{
		...
		if (!(obj instanceof EspExamList))
		{
			return false;
		}

		EspExamList examList = (EspExamList) obj;

		EqualsBuilder eb = new EqualsBuilder();
		eb.append( getExams(), examList.getExams() );
